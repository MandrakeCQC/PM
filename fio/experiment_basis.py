...
class Experiment(object):
    def __init__(self):
        # config something
        self.exp_name = 'pmem/random_noprefetch/'
        ...
        # experiment config
        config = {
          'type_pattern': ['randread'],     #'mmap' 'libaio'
    ...
    def before_each(self, config):
        ...
        # create job file
        with open('libpmem.fio.template', 'r') as input_file, open(self.cur_exp_dir + '/workload.fio', 'w') as output_file:
            for line in input_file:
                if 'bs=' in line and 'jobs' not in line:
                    output_file.write('bs=' + str(config['req_size'] * CL) + '\n')
                elif 'numjobs' in line:
                    output_file.write('numjobs=' + str(config['threads']) + '\n')
                else:
