...
class Experiment(object):
    def __init__(self):
        # config something
        #self.exp_name = 'pmem/seq_read/'
        self.exp_name = 'pmem/test/'
        ...
        config = {
          ...
          'type_pattern': ['read'],     #'read' 'write'
          #'device': ['nvm', 'ram'],     #'ram' 'nvm'
          #'device': ['nvm', 'ram'],     #'ram' 'nvm'
          'device': ['nvm'],     #'ram' 'nvm'
          ...
          'req_size': [16],     # in unit of cache line
    ...
    def exp(self, config):
        ...
        cmd = './bw_new ' + str(262144000 * config['threads']) + ' ' + str(config['threads']) + ' ' + config['device'] + ' ' + str(64 * config['req_size']) + ' ' + config['type_pattern'] + ' > ' + self.cur_exp_dir + '/running' 
        #cmd = './bw_memcpy ' + str(262144000 * config['threads']) + ' ' + str(config['threads']) + ' ' + config['device'] + ' ' + str(64 * config['req_size']) + ' ' + config['type_pattern'] + ' > ' + self.cur_exp_dir + '/running' 
        print cmd
        shcmd(cmd)
